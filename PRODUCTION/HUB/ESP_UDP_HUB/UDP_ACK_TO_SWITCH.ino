...
void UDP_ACK_Switch(String nId)
{
  ...
  String ack_string = nId + ",ack";

  char ack_string_chars[20];
  stringToCharArray(ack_string, ack_string_chars);

  UDP.write(ack_string_chars);
  UDP.endPacket();
}
