void Check_Input_String(String Check_Name)
{
  ...
  if (Check_Name.substring(0, 10) == "jackhammer")
  {
    ...
    if (Check_Name.charAt(11) == 48)
    {
      //Serial.print("Character at 11 position is: ");
      //Serial.print(Check_Name.charAt(11));
      
      Parse_State = Check_Name.substring(13, 16);
    ...
    else if(Check_Name.charAt(11) == 49)
    {
